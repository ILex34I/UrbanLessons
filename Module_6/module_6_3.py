...
class Bird(Animal):
    ...
    def lay_eggs(self):
        print(f"Here are(is) {randint(0, 4)} eggs for you")
...
class Duckbill(PoisonousAnimal, AquaticAnimal, Bird): # класс описывающий утконоса. Наследуется от классов Bird, AquaticAnimal, PoisonousAnimal.
